...
export default Class.extend({
	...
	_subscribeToHasOne: function(type, id, link){
		...
		return this._addSubscription(path, HasOneSubscription);
	},
	...
	_subscribeToHasMany: function(type, id, link){
		...
		return this._addSubscription(path, HasManySubscription);
	},

	_addSubscription: function(path, subscriptionClass, options){
		...
		if(subscription){
			...
			if(!eq(subscription.options, options)){
				console.log("subscription:updating", path);
				return subscription.update(options).then(function(){
